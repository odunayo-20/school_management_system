              ...
              <div class="card-wrap">
                <div class="padding-20">
                  <div class="text-right">
                    ...
                    <span class="text-muted"><a href="{{ route('admin_staff') }}">Staff Records</a></span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card-wrap">
                <div class="padding-20">
                  <div class="text-right">
                    ...
                    <span class="text-muted"><a href="{{ route('admin_event') }}">Event Record</a></span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card card-statistic-1">
              ...
              <div class="card-wrap">
                <div class="padding-20">
                  <div class="text-right">
                    <h3 class="font-light mb-0">
                      <i class="ti-arrow-up text-success"></i> {{ count($schoolFeesAdmin) }}
                    </h3>
                    <span class="text-muted"><a href="{{ route('admin_gallery') }}">School Fees Admin Record</a></span>
                  </div>
                </div>
              </div>
            </div>
