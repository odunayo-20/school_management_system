        ...
        <section class="section">
          <div class="section-body">
            ...
            <div class="my-2 col-12">
                          <a href="{{ route('admin_news_create') }}" class="btn btn-primary" style="float: right;">Add News</a>
                      </div>
                      ...
                      <div class="mb-0 card">
                        <div class="card-body">
                          <ul class="nav nav-pills">
                            ...
                            <li class="nav-item">
                              <a class="nav-link" href="#">Publish <span class="badge badge-primary">
                                {{ count($newsPublish) }}
                            </span></a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link" href="#">Draft <span class="badge badge-primary">
                                {{ count($newsDraft) }}
                            </span></a>
                            </li>
                          </ul>
                    ...
                    <div class="table-responsive">
                      <table id="mainTable" class="table table-striped">
                        ...
                        <td>{{ $new->date }}</td>
                                <td>{{ $new->time }}</td>
                                <td>
                                    <a href="{{ url('admin/news/view/'.$new->slug) }}" class="btn btn-sm btn-warning"><i
                                        class="fa fa-eye"></i></a>
                                    <a href="{{ url('admin/news/edit/'.$new->slug) }}" class="btn btn-sm btn-primary"><i
                                        class="fa fa-pen"></i></a>
