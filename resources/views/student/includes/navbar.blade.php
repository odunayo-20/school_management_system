          ...
          <ul class="navbar-nav navbar-right">
            {{-- <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown"
              ...
              <div class="dropdown-menu dropdown-list dropdown-menu-right pullDown">
                ...
                <div class="dropdown-list-content dropdown-list-message">
                  <a href="#" class="dropdown-item"> <span class="text-white dropdown-item-avatar"> <img alt="image" src="assets/img/users/user-1.png"
            ...
            <li class="dropdown"><a href="#" data-toggle="dropdown"
              ...
              <div class="dropdown-menu dropdown-menu-right pullDown">
                ...
                <a href="{{ route('student_profile') }}" class="dropdown-item has-icon"> <i class="far fa-user"></i> Profile
                </a>
                <div class="dropdown-divider"></div>
                {{-- @livewire('student.auth.StudentLogout') --}}
                <a href="{{ route('student_logout') }}"  class="dropdown-item has-icon text-danger" style="cursor: pointer">
